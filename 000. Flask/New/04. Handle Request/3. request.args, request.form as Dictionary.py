...
def index():
    ...
    # 코드가 너무 길어진다. request.args와 request.form은 MultiDict 클래스의 객체이며, 해당 클래스의 상위 클래스인
    # werkzeug.datastructures.TypeConversionDict에는 .get 메소드에서 type conversion을 지원한다고 했다

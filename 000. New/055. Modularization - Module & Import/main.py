# 모듈은 비슷한 기능을 하는 요소들을 묶어 재사용성을 높이기 위해 사용된다. 의도는 함수와 동일하다
# calculator.py 모듈을 생성하여 계산에 관한 함수들을 정의해 두었으며, 이들은 아래처럼 import 키워드를 통해 가져와 사용할 수 있다

import calculator
print(calculator.calculate(calculator.add, 1, 3)) # 4

...
# C와 같은 언에서의 and, or 연산은 두 피연산자에 대한 논리 연산의 결과(true/false)만 반환하지만
# Python의 논리 연산은 해당 condition을 그대로 반환한다. 좌측에서 우측으로 연산을 진행한다고 생각하면 되며,
...
# -- is & not is
# 둘 이상의 객체의 주소값을 비교(is)할 수 있다
print('PlanB' is 'PlanB')
# True

print('PlanB' is not 'PlanB')
# False